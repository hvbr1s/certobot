...
def process_file(file_path, base_path, output_dir):
    ...
    try:
        ...
        url = f"https://github.com/Certora/Documentation/{file_path.relative_to(base_path).as_posix()}"
...
def main():
    base_path = Path('/Users/danieljaheny/Documents/dev/certobot/pinecone_pipeline/update_scripts/raw_docs')
